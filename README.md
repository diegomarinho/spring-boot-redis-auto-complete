[![Build Status](https://travis-ci.org/diegomarinho/spring-boot-redis-auto-complete.svg?branch=master)](https://travis-ci.org/diegomarinho/spring-boot-redis-auto-complete)
